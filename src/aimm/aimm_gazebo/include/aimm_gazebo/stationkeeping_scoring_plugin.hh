...
#ifndef AIMM_GAZEBO_STATIONKEEPING_SCORING_PLUGIN_HH_
#define AIMM_GAZEBO_STATIONKEEPING_SCORING_PLUGIN_HH_
...
#include "aimm_gazebo/waypoint_markers.hh"
...
class StationkeepingScoringPlugin : public ScoringPlugin
{
  ...
  private: std::string goalTopic = "/aimm/station_keeping/goal";

  /// \brief Topic where 2D pose error is published
  private: std::string poseErrorTopic = "/aimm/station_keeping/pose_error";

  /// \brief Topic where mean pose error is published.
  private: std::string meanErrorTopic = "/aimm/station_keeping/mean_pose_error";
