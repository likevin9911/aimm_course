...
#ifndef AIMM_GAZEBO_WILDLIFE_SCORING_PLUGIN_HH_
#define AIMM_GAZEBO_WILDLIFE_SCORING_PLUGIN_HH_
...
///                  Defaults to "/aimm/wildlife/animals/poses"
...
class WildlifeScoringPlugin : public ScoringPlugin
{
  ...
  private: std::string animalsTopic = "/aimm/wildlife_animals";
