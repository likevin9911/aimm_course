...
#ifndef AIMM_GAZEBO_WAYFINDING_SCORING_PLUGIN_HH_
#define AIMM_GAZEBO_WAYFINDING_SCORING_PLUGIN_HH_
...
class WayfindingScoringPlugin : public ScoringPlugin
{
  ...
  private: std::string waypointsTopic = "/aimm/wayfinding/waypoints";

  /// \brief Topic where the current minimum pose error distance for each
  /// waypoint is published.
  private: std::string minErrorsTopic = "/aimm/wayfinding/min_errors";

  /// \brief Topic where the current average minimum error is published.
  private: std::string meanErrorTopic = "/aimm/wayfinding/mean_error";
