...
class PingerPosition:
    ...
    def __init__(self):
        ...
        self.pingerPub = rospy.Publisher("/lpv/sensors/pingers/pinger/set_pinger_position",
                                         Vector3, queue_size=10, latch=True)
        self.markerPub = rospy.Publisher("/lpv/sensors/pingers/pinger/marker/ground_truth", Marker,
