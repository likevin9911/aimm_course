...
from aimm_gazebo.utils import create_xacro_file
...
def make_xacro_top(coord, world_name):
  ...
  xacro_includes = """\
  <xacro:include filename="$(find aimm_2019)/worlds/sandisland.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/sandisland_minus_scene.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/sydneyregatta_minus_scene.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/scene.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/nav_challenge.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/usv_wind_plugin.xacro" />
  <xacro:include filename="$(find wave_gazebo)/world_models/ocean_waves/model.xacro"/>
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/perception.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/stationkeeping.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/dock.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/scan_and_dock.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/wayfinding.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/wildlife.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/scan_dock_deliver.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/gymkhana.xacro" />
  <xacro:include filename="$(find aimm_gazebo)/worlds/xacros/insert_model.xacro" />
  """
