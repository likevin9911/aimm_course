...
# spawn_lpv.bash: A bash script to spawn a lpv model using gz.
...
#
# E.g.: ./spawn_lpv.bash -x <x> -y <y> -z <z> -R <R> -P <P> -Y <Y> --urdf <urdf> --model <model>
...
sed -e "s/aimm_gazebo\/models\///g" -i $final_urdf
sed -e "s/lpv_gazebo\/models\///g" -i $final_urdf
sed -e "s/lpv_description\/models\///g" -i $final_urdf
