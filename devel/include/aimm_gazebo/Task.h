// Generated by gencpp from file aimm_gazebo/Task.msg
// DO NOT EDIT!


#ifndef AIMM_GAZEBO_MESSAGE_TASK_H
#define AIMM_GAZEBO_MESSAGE_TASK_H
...
struct Task_
{
  ...
  typedef boost::shared_ptr< ::aimm_gazebo::Task_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::aimm_gazebo::Task_<ContainerAllocator> const> ConstPtr;

}; // struct Task_

typedef ::aimm_gazebo::Task_<std::allocator<void> > Task;

typedef boost::shared_ptr< ::aimm_gazebo::Task > TaskPtr;
typedef boost::shared_ptr< ::aimm_gazebo::Task const> TaskConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::aimm_gazebo::Task_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::aimm_gazebo::Task_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::aimm_gazebo::Task_<ContainerAllocator1> & lhs, const ::aimm_gazebo::Task_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::aimm_gazebo::Task_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::aimm_gazebo::Task_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::aimm_gazebo::Task_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::aimm_gazebo::Task_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aimm_gazebo::Task_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aimm_gazebo::Task_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::aimm_gazebo::Task_<ContainerAllocator> >
{
  ...
  static const char* value(const ::aimm_gazebo::Task_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8b3267cadc02a4d8ULL;
  static const uint64_t static_value2 = 0x846adeb79baa09a1ULL;
};

template<class ContainerAllocator>
struct DataType< ::aimm_gazebo::Task_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::aimm_gazebo::Task_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Task name.\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::aimm_gazebo::Task_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::aimm_gazebo::Task_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::aimm_gazebo::Task_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
...
#endif // AIMM_GAZEBO_MESSAGE_TASK_H
