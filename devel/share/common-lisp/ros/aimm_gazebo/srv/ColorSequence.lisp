...
(cl:defmethod cl:initialize-instance :after ((m <ColorSequence-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColorSequence-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimm_gazebo-srv:<ColorSequence-request> is deprecated: use aimm_gazebo-srv:ColorSequence-request instead.")))

(cl:ensure-generic-function 'color1-val :lambda-list '(m))
(cl:defmethod color1-val ((m <ColorSequence-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-srv:color1-val is deprecated.  Use aimm_gazebo-srv:color1 instead.")
  (color1 m))

(cl:ensure-generic-function 'color2-val :lambda-list '(m))
(cl:defmethod color2-val ((m <ColorSequence-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-srv:color2-val is deprecated.  Use aimm_gazebo-srv:color2 instead.")
  (color2 m))

(cl:ensure-generic-function 'color3-val :lambda-list '(m))
(cl:defmethod color3-val ((m <ColorSequence-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-srv:color3-val is deprecated.  Use aimm_gazebo-srv:color3 instead.")
  (color3 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ColorSequence-request>)))
  ...
  "aimm_gazebo/ColorSequenceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ColorSequence-request)))
  "Returns string type for a service object of type 'ColorSequence-request"
  "aimm_gazebo/ColorSequenceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ColorSequence-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColorSequence-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimm_gazebo-srv:<ColorSequence-response> is deprecated: use aimm_gazebo-srv:ColorSequence-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ColorSequence-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-srv:success-val is deprecated.  Use aimm_gazebo-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ColorSequence-response>)))
  ...
  "aimm_gazebo/ColorSequenceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ColorSequence-response)))
  "Returns string type for a service object of type 'ColorSequence-response"
  "aimm_gazebo/ColorSequenceResponse")
