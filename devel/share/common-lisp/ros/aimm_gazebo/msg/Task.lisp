...
(cl:defmethod cl:initialize-instance :after ((m <Task>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimm_gazebo-msg:<Task> is deprecated: use aimm_gazebo-msg:Task instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:name-val is deprecated.  Use aimm_gazebo-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:state-val is deprecated.  Use aimm_gazebo-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'ready_time-val :lambda-list '(m))
(cl:defmethod ready_time-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:ready_time-val is deprecated.  Use aimm_gazebo-msg:ready_time instead.")
  (ready_time m))

(cl:ensure-generic-function 'running_time-val :lambda-list '(m))
(cl:defmethod running_time-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:running_time-val is deprecated.  Use aimm_gazebo-msg:running_time instead.")
  (running_time m))

(cl:ensure-generic-function 'elapsed_time-val :lambda-list '(m))
(cl:defmethod elapsed_time-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:elapsed_time-val is deprecated.  Use aimm_gazebo-msg:elapsed_time instead.")
  (elapsed_time m))

(cl:ensure-generic-function 'remaining_time-val :lambda-list '(m))
(cl:defmethod remaining_time-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:remaining_time-val is deprecated.  Use aimm_gazebo-msg:remaining_time instead.")
  (remaining_time m))

(cl:ensure-generic-function 'timed_out-val :lambda-list '(m))
(cl:defmethod timed_out-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:timed_out-val is deprecated.  Use aimm_gazebo-msg:timed_out instead.")
  (timed_out m))

(cl:ensure-generic-function 'num_collisions-val :lambda-list '(m))
(cl:defmethod num_collisions-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:num_collisions-val is deprecated.  Use aimm_gazebo-msg:num_collisions instead.")
  (num_collisions m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:score-val is deprecated.  Use aimm_gazebo-msg:score instead.")
  (score m))
