...
(cl:defmethod cl:initialize-instance :after ((m <Contact>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contact)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimm_gazebo-msg:<Contact> is deprecated: use aimm_gazebo-msg:Contact instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:header-val is deprecated.  Use aimm_gazebo-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'collision1-val :lambda-list '(m))
(cl:defmethod collision1-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:collision1-val is deprecated.  Use aimm_gazebo-msg:collision1 instead.")
  (collision1 m))

(cl:ensure-generic-function 'collision2-val :lambda-list '(m))
(cl:defmethod collision2-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimm_gazebo-msg:collision2-val is deprecated.  Use aimm_gazebo-msg:collision2 instead.")
  (collision2 m))
