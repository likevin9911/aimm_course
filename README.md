...
## The AIMM Course Challenge


## Getting Started

 * The instructions assume a basic familiarity with the ROS1 Noetic environment and Gazebo 11. Running on Ubuntu 20.04 LTS.
 * If these tools are new to you, we recommend starting with the excellent [ROS Tutorials](http://wiki.ros.org/ROS/Tutorials)
...
If you have any questions about these topics, or would like to work on other aspects, please contribute.  


## Contributor Contacts

 * Kevin Li <kgli@mtu.edu>
 * Tyler Ryynanen <ttryynan@mtu.edu>
